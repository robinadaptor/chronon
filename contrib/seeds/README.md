...
The seeds compiled into the release are created from robinadaptor's DNS seed data,
like this:

```
curl -s https://github.com/chronon-seeder/chronon-mainnet.txt > seeds_main.txt
