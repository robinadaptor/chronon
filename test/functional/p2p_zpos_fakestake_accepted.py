#!/usr/bin/env python3
# Copyright (c) 2019 PIVX Core developers
...
from fake_stake.base_test import CHN_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(CHN_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zchnstake']] * self.num_nodes
