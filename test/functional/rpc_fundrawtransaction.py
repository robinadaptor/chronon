#!/usr/bin/env python3
# Copyright (c) 2014-2016 Bitcoin Core developers
...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid chronon address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid chronon address" in e.error['message'])
