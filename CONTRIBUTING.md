Contributing to Chronon Core
============================

Chronon Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/robinadaptor/chronon/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Chronon Core project, and is not to be
confused with overall Chronon Network Protocol consensus changes.

Whether a pull request is merged into Chronon Core rests with the project merge
...
Patches that change Chronon consensus rules are considerably more involved than
...
Where a patchset proposes to change the Chronon consensus, it must have been
...
The project leader is the release manager for each Chronon Core release.
