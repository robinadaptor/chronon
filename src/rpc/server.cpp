...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"chronon", "listmasternodes", &listmasternodes, true, true, false},
        {"chronon", "masternodelist", &masternodelist, true, true, false},		
        {"chronon", "getmasternodecount", &getmasternodecount, true, true, false},
        {"chronon", "masternodeconnect", &masternodeconnect, true, true, false},
        {"chronon", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"chronon", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"chronon", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"chronon", "masternodecurrent", &masternodecurrent, true, true, false},
        {"chronon", "masternodedebug", &masternodedebug, true, true, false},
        {"chronon", "startmasternode", &startmasternode, true, true, false},
        {"chronon", "createmasternodekey", &createmasternodekey, true, true, false},
        {"chronon", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"chronon", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"chronon", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"chronon", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"chronon", "getmasternodescores", &getmasternodescores, true, true, false},
        {"chronon", "mnbudget", &mnbudget, true, true, false},
        {"chronon", "preparebudget", &preparebudget, true, true, false},
        {"chronon", "submitbudget", &submitbudget, true, true, false},
        {"chronon", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"chronon", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"chronon", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"chronon", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"chronon", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"chronon", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"chronon", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"chronon", "mnfinalbudget", &mnfinalbudget, true, true, false},				
        {"chronon", "checkbudgets", &checkbudgets, true, true, false},
        {"chronon", "mnsync", &mnsync, true, true, false},
        {"chronon", "spork", &spork, true, true, false},
        {"chronon", "getpoolinfo", &getpoolinfo, true, true, false},
