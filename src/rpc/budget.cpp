...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 6)
        throw std::runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"chronon-address\" monthy-payment\n"
            ...
            "5. \"chronon-address\":   (string, required) Chronon address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.chronon.org/t/test-proposal\" 2 820800 \"UYB43zFEsQMmHEfZsHSZQ3ossbJ12f4xrp\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.chronon.org/t/test-proposal\" 2 820800 \"UYB43zFEsQMmHEfZsHSZQ3ossbJ12f4xrp\" 500"));
    ...
    CWalletTx wtx;
    if (!pwalletMain->GetBudgetSystemCollateralTX(wtx, budgetProposalBroadcast.GetHash(), useIX)) { // 50 CHN collateral for proposal
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 7)
        throw std::runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"chronon-address\" monthly-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.chronon.org/t/test-proposal\" 2 820800 \"UYB43zFEsQMmHEfZsHSZQ3ossbJ12f4xrp\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.chronon.org/t/test-proposal\" 2 820800 \"UYB43zFEsQMmHEfZsHSZQ3ossbJ12f4xrp\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) Chronon address of payment\n"
