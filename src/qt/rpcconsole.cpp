                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCHNPathCustom = GetArg("-zchnbackuppath", "");
    ...
    if((!strPathCustom.empty() || !strzCHNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Chronon RPC console.") + "<br>" +
