...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Chronon address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
{
    // return if URI is not valid or is no Chronon: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Chronon.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Chronon.lnk
