...
UniValue importaddress(const UniValue& params, bool fHelp)
{
    ...
    if (address.IsValid()) {
        ...
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Chronon address or script");
    }
...
UniValue dumpwallet(const UniValue& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by Chronon %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            "bip38encrypt \"chrononaddress\" \"passphrase\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("bip38encrypt", "\"XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwg\" \"mypasphrase\"") +
            HelpExampleRpc("bip38encrypt", "\"XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwg\" \"mypasphrase\""));
...
UniValue bip38decrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            "bip38decrypt \"chrononaddress\" \"passphrase\"\n"
